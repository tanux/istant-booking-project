...
[ExcludeClass]
internal class _VOUserEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("id", "name", "surname", "username", "password");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "name", "surname", "username", "password");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "name", "surname", "username", "password");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "name", "surname", "username", "password");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("id", "name", "surname", "username", "password");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "VOUser";
    ...
    model_internal var _surnameIsValid:Boolean;
    model_internal var _surnameValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _surnameIsValidCacheInitialized:Boolean = false;
    model_internal var _surnameValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_VOUser;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _VOUserEntityMetadata(value : _Super_VOUser)
    {
        ...
        model_internal::propertyTypeMap["surname"] = "Object";
        model_internal::propertyTypeMap["username"] = "Object";
        ...
        model_internal::_surnameValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForSurname);
        model_internal::_surnameValidator.required = true;
        model_internal::_surnameValidator.requiredFieldError = "surname is required";
        //model_internal::_surnameValidator.source = model_internal::_instance;
        //model_internal::_surnameValidator.property = "surname";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity VOUser");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity VOUser");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of VOUser");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity VOUser");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity VOUser");
        }
    ...
    public function invalidateDependentOnSurname():void
    {
        if (model_internal::_surnameIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfSurname = null;
            model_internal::calculateSurnameIsValid();
        }
    }
    ...
    public function get surnameValidator() : StyleValidator
    {
        return model_internal::_surnameValidator;
    }

    model_internal function set _surnameIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_surnameIsValid;         
        if (oldValue !== value)
        {
            model_internal::_surnameIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "surnameIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get surnameIsValid():Boolean
    {
        if (!model_internal::_surnameIsValidCacheInitialized)
        {
            model_internal::calculateSurnameIsValid();
        ...
        return model_internal::_surnameIsValid;
    }

    model_internal function calculateSurnameIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_surnameValidator.validate(model_internal::_instance.surname)
        model_internal::_surnameIsValid_der = (valRes.results == null);
        model_internal::_surnameIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::surnameValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::surnameValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get surnameValidationFailureMessages():Array
    {
        if (model_internal::_surnameValidationFailureMessages == null)
            model_internal::calculateSurnameIsValid();

        return _surnameValidationFailureMessages;
    }

    model_internal function set surnameValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_surnameValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_surnameValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "surnameValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("surname"):
            {
                return surnameValidationFailureMessages;
            }
            case("username"):
            {
