 ...
 * of this service wrapper you may modify the generated sub-class of this class - ManagerLoginService.as.
 */
...
[ExcludeClass]
internal class _Super_ManagerLoginService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_ManagerLoginService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "doLogin");
         operation.resultType = model.vo.Manager;
        ...
        _serviceControl.source = "ManagerLoginService";
    ...
    {
        destination = "ManagerLoginService";
